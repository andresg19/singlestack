...
export const FILTER_LIKES_FORO = "FILTER_LIKES_FORO";
export const FILTER_COMMENTS_FORO = "FILTER_COMMENTS_FORO";
export const FILTER_DATE_FORO = "FILTER_DATE_FORO";
...
export const GET_POSTSRECIENTES = "GET_POSTSRECIENTES";
export const SEARCH_FEEDPOST_ID = "SEARCH_FEEDPOST_ID";
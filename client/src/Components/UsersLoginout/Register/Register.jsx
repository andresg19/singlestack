...
const Register = () => {
  ...
  return (
    ...
    <Nav />
    <div className="mt-[25%] bg-black shadow-md shadow-[#0f0f0fbd] rounded-xl w-[100%] h-[75vh] ml-auto mr-auto text-slate-200 font-sans font-light ">
      <div className="grid w-[90%] p-1 ml-auto mr-auto">
        <h1 className="mx-auto text-slate-300 italic font-medium">Ingrese sus datos</h1>
      </div>
      <form className="flex flex-col p-10 max-w-[90%] ml-auto mr-auto" onSubmit={handleSubmit}>
        <input
          id="small-input" 
